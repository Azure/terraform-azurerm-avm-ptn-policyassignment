...
output "resource_id" {
  ...
  value = concat(
    azurerm_management_group_policy_assignment.this[*].id,
    azurerm_resource_group_policy_assignment.this[*].id,
    azurerm_resource_policy_assignment.this[*].id,
  azurerm_subscription_policy_assignment.this[*].id)[0]
}
